...
def returnPred():
    ...
    loaded1=joblib.load('lib/kerala/model_tree.joblib')
    # loaded2=joblib.load('lib/kerala/model_xgb.joblib') 
    loaded3=joblib.load('lib/kerala/model_random_forest.joblib') 
    loaded4=joblib.load('lib/kerala/model_logistic_regression.joblib')
